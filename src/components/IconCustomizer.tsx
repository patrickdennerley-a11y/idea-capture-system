...
export const DEFAULT_THEME = {
  icon: 'brain-lucide',
  strokeColor: '#ffffff',
  bgType: 'gradient' as 'solid' | 'gradient',
  bgColor: '#a855f7',
          ...
          <div>
            ...
            <div className="flex gap-3 items-center">
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setLocalTheme({ ...localTheme, strokeColor: e.target.value })}
              ...
              <div>
                ...
                <div className="flex gap-3 items-center">
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setLocalTheme({ ...localTheme, bgColor: e.target.value })}
                    className="w-16 h-12 rounded-lg cursor-pointer border-2 border-gray-800"
                  />
                  <input
                    type="text"
              ...
              <div>
                ...
                <div className="flex gap-3 items-center">
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setLocalTheme({ ...localTheme, bgGradientEnd: e.target.value })}
                    className="w-16 h-12 rounded-lg cursor-pointer border-2 border-gray-800"
                  />
                  <input
                    type="text"
