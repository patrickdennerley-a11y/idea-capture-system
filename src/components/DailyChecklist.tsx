...
interface DailyChecklistProps {
  ...
  setChecklist: (checklist: Checklist | ((prev: Checklist) => Checklist)) => void;
}
...
export default function DailyChecklist({ checklist, setChecklist }: DailyChecklistProps) {
...
function CalendarView({ history, checklist, onClose }: CalendarViewProps) {
